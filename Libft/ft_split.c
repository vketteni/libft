...
int main(void)
{
	...
	printf("String:\t\t'%s'\nDelimiter:\t'%s'\nResult:\t\t'%s'\nExpected:\t'%s'\nPass:\t\t%s\n\n", test_1, " ", result_1[0], expected_1[0], *result_1[0] == *expected_1[0] && result_1[1] == expected_1[1] ? "Yes" : "No");
	...
	printf("String:\t\t'%s'\nDelimiter:\t'%s'\nResult:\t\t'%s'\nExpected:\t'%s'\nPass:\t\t%s\n\n", test_4, "F",result_4[0], expected_4[0], strcmp(result_4[0], expected_4[0]) == 0 && strcmp(result_4[1], expected_4[1]) == 0 ? "Yes" : "No");
	...
	printf("String:\t\t'%s'\nDelimiter:\t'%s'\nResult:\t\t'%s'\nExpected:\t'%s'\nPass:\t\t%s\n\n", test_5, "Z",result_5[0], expected_5[0], strcmp(result_5[0], expected_5[0]) == 0  ? "Yes" : "No");
	...
	printf("String:\t\t'%s'\nDelimiter:\t'%s'\nResult:\t\t'%s' '%s'\nExpected:\t'%s' '%s'\nPass:\t\t%s\n\n", test_6, "s",result_6[0], result_6[1], expected_6[0], expected_6[1], strcmp(result_6[0], expected_6[0]) == 0 && strcmp(result_6[1], expected_6[1]) == 0 && strcmp(result_6[2], expected_6[2]) == 0 ? "Yes" : "No");
	free_split_result(result_6);

	// Test Case 7: Testing split with match on every char in string.
	printf("Test Case 7: Testing split with match on every char in string.");
	char *test_7 = "AAAAAAAAA";
	char **result_7 = ft_split(test_7, 'A');
	char *expected_7[] = {NULL};
	printf("String:\t\t'%s'\nDelimiter:\t'%s'\nResult:\t\t'%p'\nExpected:\t'%p'\nPass:\t\t%s\n\n", test_7, "A", result_7[0], expected_7[0], *result_7[0] == *expected_7[0] ? "Yes" : "No");
